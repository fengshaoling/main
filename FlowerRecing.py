...
from vegetable.label_name import Chinese_name
...
class Flower_MainWindow(QMainWindow):
    def __init__(self, *args, obj=None, **kwargs):
        super(Flower_MainWindow, self).__init__(*args, **kwargs)
        ...
        self.c_video = 0
        self.count_name = ["大葱花", "琉璃苣", "牛蒡", "金盏花", "菊苣", "韭菜花", "款冬", "锦葵",
                           "洋蓍草", "金光菊", "欧芹", "蒲公英", "栀子花"]
        self.count_table = []
        self.plotBar(self.count_name, [0 for i in self.count_name], self.colors, margin=5)
            ...
            if col == 0:  # 点击第一列时
                ...
                if (this_path is not None) & (res is not None) & (axes is not None):
                    ...
                    if os.path.exists(this_path):
                        ...
                        self.plotBar(self.count_name, count, self.colors, margin=5)
    ...
    def LoadModel(self, model_path=None):
        ...
        parser.add_argument('--weights', nargs='+', type=str, default='./weights/vegetable-best.pt',
