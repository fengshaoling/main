...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/vegetable/vegetable.yaml', help='garbage.yaml path')
    ...
    parser.add_argument('--logdir', type=str, default='vegetable/logs', help='logging directory')
