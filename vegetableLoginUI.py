...
class LoginForm(QWidget):
    def __init__(self):
        ...
        self.bird_main = self.Flower_Main()

    class Flower_Main(Flower_MainWindow):
        pass
    ...
    def initUI(self):
        ...
        self.setWindowTitle("FSL")
        self.setWindowIcon(QIcon('icons/shu2.png'))

        # 添加顶部logo图片
        pixmap = QPixmap("icons/back-image12.jpg")
        scaredPixmap = pixmap.scaled(680, 200)
        label = QLabel(self)
        ...
        # 添加左侧logo
        logolb = QLabel(self)
        logopix = QPixmap("icons/biao.png")
        logopix_scared = logopix.scaled(140, 140)
